...
void Image(const sf::Texture& texture, const sf::Vector2f& size,
    ...
    ImTextureID textureID =
        convertGLTextureHandleToImTextureID(texture.getNativeHandle());
    ImGui::Image(textureID, ImVec2(size.x, size.y), ImVec2(0, 0), ImVec2(1, 1), ImVec4(tintColor.r, tintColor.g, tintColor.b, tintColor.a),
...
void Image(const sf::Texture& texture, const sf::Vector2f& size,
    ...
    ImTextureID textureID =
        convertGLTextureHandleToImTextureID(texture.getNativeHandle());
    ImGui::Image(textureID, ImVec2(size.x, size.y), uv0, uv1, ImVec4(tintColor.r, tintColor.g, tintColor.b, tintColor.a),
        ImVec4(borderColor.r, borderColor.g, borderColor.b, borderColor.a));
}
...
void DrawLine(const sf::Vector2f& a, const sf::Vector2f& b,
    ...
    sf::Vector2f pos = sf::Vector2f(ImGui::GetCursorScreenPos().x, ImGui::GetCursorScreenPos().y);
    draw_list->AddLine(ImVec2(a.x + pos.x, a.y + pos.y), ImVec2(b.x + pos.x, b.y + pos.y), ColorConvertFloat4ToU32(ImVec4(color.r, color.g, color.b, color.a)),
                       thickness);
}
...
void DrawRect(const sf::FloatRect& rect, const sf::Color& color, float rounding,
    ...
    draw_list->AddRect(getTopLeftAbsolute(rect), getDownRightAbsolute(rect),
                       ColorConvertFloat4ToU32(ImVec4(color.r, color.g, color.b, color.a)), rounding,
...
bool imageButtonImpl(const sf::Texture& texture,
    ...
    ImTextureID textureID =
        convertGLTextureHandleToImTextureID(texture.getNativeHandle());
    return ImGui::ImageButton(textureID, ImVec2(size.x, size.y), uv0, uv1, framePadding, ImVec4(bgColor.r, bgColor.g, bgColor.b, bgColor.a),
